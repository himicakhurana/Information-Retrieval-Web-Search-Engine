...
.search-result span.border { display: block; width: 97%; margin: 0 15px; border-bottom: 1px dotted #ccc; }
  ...
  <body>
    <form id="dornsife" accept-charset="utf-8" method="get">
      ...
      <input id="q" name="q" required  type="text" value="<?php echo htmlspecialchars($query, ENT_QUOTES, 'utf-8'); ?>"/>
...
?>
    ...
    <hgroup class="mb20">
		...
		<h2 class="lead"><strong class="text-danger"><?php echo $total; ?></strong> results were found for the search for <strong class="text-danger"><?php echo htmlspecialchars($query, ENT_QUOTES, 'utf-8'); ?></strong></h2>								
	    <div>Results <strong class="text-danger"><?php echo $start; ?></strong> - <strong class="text-danger"><?php echo $end;?> </strong>of <strong class="text-danger"><?php echo $total; ?></strong>:</div>
